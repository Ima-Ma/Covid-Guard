            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class=" bg-light  card-header">
                        <h4 class="text-dark card-title">Appointment Booked!</h4>
                    </div>
                    <div class="card-body">
                        <div class="table">
                            <table class="table text-dark">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rows['id'] ?>
                                                ...
                                                <td><a href="create_report.php?id=<?php echo $rows['id'];?>" class="btn btn-primary">Create Report<i class="bi bi-pencil-square"></i></a></td>
